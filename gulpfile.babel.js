...
import develop_server from 'gulp-develop-server';
import gulp_nodemon from 'gulp-nodemon';
...
gulp.task('start:server', () => {
  ...
  /*
  var server_app = require('server/app.js');
  console.log(server_app);
*/

  /*
  exec(`node ${serverPath}`, function (err, stdout, stderr) {
    console.log(stdout);
    console.log(stderr);
  });
  */
  ...
  /*
   develop_server.listen({path:`${serverPath}`, port:9000});
*/
